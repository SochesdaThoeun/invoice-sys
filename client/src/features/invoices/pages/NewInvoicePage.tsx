...
import { type CreateInvoiceRequest } from '../models/invoiceModels';
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <h3 className="text-sm font-medium text-red-800 mb-2">
                Please fix the following issues before creating the invoice:
              </h3>
...
function InvoicePreview({ customer, items, subtotal, totalTax, total, language, governmentTemplate, user, userProfile, primaryBusinessAddress }: InvoicePreviewProps) {
  return (
    <div className="bg-white p-4 sm:p-8 space-y-6 sm:space-y-8 text-black">
      {/* Header */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-start gap-4 sm:gap-0">
        <div>
          ...
          <p className="text-lg text-gray-600 mt-1">#NEW</p>
        </div>
