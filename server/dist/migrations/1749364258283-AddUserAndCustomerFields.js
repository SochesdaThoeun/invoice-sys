...
exports.AddUserAndCustomerFields1749364258283 = void 0;
class AddUserAndCustomerFields1749364258283 {
    constructor() {
        this.name = 'AddUserAndCustomerFields1749364258283';
    }
    async up(queryRunner) {
        ...
        // Update any existing records with a default value
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "ledger_entries" DROP COLUMN "transactionGroupId"`);
        await queryRunner.query(`ALTER TABLE "ledger_entries" ADD "transactionGroupId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ledger_entries" DROP COLUMN "sourceId"`);
        await queryRunner.query(`ALTER TABLE "ledger_entries" ADD "sourceId" uuid NOT NULL`);
...
exports.AddUserAndCustomerFields1749364258283 = AddUserAndCustomerFields1749364258283;
